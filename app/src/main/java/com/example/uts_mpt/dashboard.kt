...
class dashboard : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnSimpan.setOnClickListener() {
            ...
            val data_hp: String = hp.text.toString()
    ...
    fun getdariserver() {
        ...
        AndroidNetworking.get("http://data-mahasiswa-ti.000webhostapp.com/uts/penduduk_json.php")
    ...
    fun postkeserve(data1: String, data2: String, data3: String, data4: String) {
        AndroidNetworking.post("http://data-mahasiswa-ti.000webhostapp.com/uts/add_penduduk.php")
